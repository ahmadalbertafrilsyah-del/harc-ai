      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden pb-[70px] md:pb-0 relative">
        ...
        <header className="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-4 md:px-6 shrink-0 z-30">
          ...
          <div className="hidden md:flex items-center justify-end gap-5">
            ...
            {/* Profil Lembaga */}
            <div className="flex items-center gap-3 cursor-pointer hover:bg-slate-50 p-1.5 pr-3 rounded-xl transition-colors" aria-label="Profil Lembaga">
              ...
              <div className="w-9 h-9 bg-purple-700 text-white rounded-lg flex items-center justify-center text-xs font-bold shadow-sm" aria-hidden="true">
          ...
          return (
            <Link key={item.name} href={item.path} className="flex-1 flex flex-col justify-center items-center h-full group" aria-current={isActive ? "page" : undefined}>
              <div className={`p-1.5 rounded-xl transition-all mb-1 ${isActive ? "bg-purple-100 text-purple-700" : "text-slate-400 group-hover:text-purple-500"}`}>
                <item.icon size={22} className={isActive ? "fill-purple-100/50" : ""} aria-hidden="true"/>
              </div>
